      ...
      <div>
        ...
        <div className="sidebar" data-color="mysidebarcolor2">
          <div className="logo">
            ...
            <a className="simple-text logo-normal" href="https://focus-foto.dk">Focus Foto </a>
            {/* ---------------------------- */}
          </div>
          ...
          <div className="sidebar-wrapper" ref="sidebar">
            <div className="user">
              <div className="photo">
                <img
                  src={
                    "https://api.adorable.io/avatars/180/abott@adorable.pngCopy"
                  }
                  alt="Avatar"
                />
              </div>
            ...
            <Button style={{backgroundColor: "red", marginTop: "20px", fontFamily: "verdana"}} onClick={this.logout}>Logout</Button>
          </div>
        </div>
      </div>
    );
